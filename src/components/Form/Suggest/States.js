...
import { useStyles, getCountryOrStateSuggestions } from 'components/Form/Suggest/shared'
...
const renderSuggestionsContainer = ({ containerProps, children, query }) => {
  ...
  return (
    <Paper {...containerProps}>
      <MenuList component="div" disablePadding id="quickcheckout-stateOrProvince">
        {children}
      </MenuList>
    </Paper>
  )
